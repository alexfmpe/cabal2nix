...
hooks =
  ...
  , ("bindings-GLFW", over (libraryDepends . condTreeData . system) (Set.union (Set.fromList [bind "pkgs.libxext", bind "pkgs.libxfixes"])))
  ...
  , ("fltkhs", set (libraryDepends . condTreeData . system . contains (pkg "fltk_1_4")) True . over (libraryDepends . condTreeData . pkgconfig) (Set.union (pkgs ["libGLU", "libGL"]))) -- TODO: fltk14 belongs into the *setup* dependencies.
  ...
  , ("GLFW", over (libraryDepends . condTreeData . system) (Set.union (Set.fromList [bind "pkgs.libxext", bind "pkgs.libxfixes"])))
  ...
  , ("X11", over (libraryDepends . condTreeData . system) (Set.union (Set.fromList $ map bind ["pkgs.libxinerama","pkgs.libxext","pkgs.libxrender","pkgs.libxscrnsaver"])))
...
wxcHook drv = drv & libraryDepends . condTreeData . system %~ Set.union (Set.fromList [pkg "libGL", bind "pkgs.libx11"])
